...
export const BRAND_COMPANIES: BrandCompanyInfo[] = [
  {
    ...
    founded: '1964',
    pronunciation: 'NY-kee',
    famousFor: 'Air Force 1s, Jordan retro sneakers, Dri-FIT athletic wear, and cutting-edge streetwear collabs.',
    priceTier: '$$$',
    tomboyStreetwearVibe: 'The undisputed king of sneaker culture and modern sporty street aesthetic.',
    keyProducts: ['Air Force 1 Low', 'Air Jordan 1 Retro High', 'Tech Fleece Joggers', 'Dunk Low Retro']
  },
  {
    id: 'zara',
    ...
    famousFor: 'Fast-fashion runway trends, chic blazers, wide-leg trousers, structured coats, and modern minimalist basics.',
    priceTier: '$$',
    tomboyStreetwearVibe: 'Sleek European smart casual, tailored oversized blazers, and contemporary silhouettes.',
    keyProducts: ['Oversized Tailored Blazer', 'Wide-Leg Pleated Trousers', 'Faux Leather Biker Jacket', 'Satin Slip Skirt']
  },
  {
    id: 'uniqlo',
    ...
    country: 'Japan (Tokyo)',
    founded: '1949',
    pronunciation: 'YOO-nee-kloh',
    famousFor: 'LifeWear philosophy: High-quality minimalist essentials, AIRism cooling base layers, and HEATTECH thermal wear.',
    priceTier: '$',
    tomboyStreetwearVibe: 'Clean Japanese minimalist aesthetic with oversized boxy tees, parachute pants, and round mini shoulder bags.',
    keyProducts: ['AIRism Oversized Cotton Tee', 'Round Mini Shoulder Bag', 'Ultra Light Down Jacket', 'Wide-Fit Pleated Chinos']
  },
  {
    id: 'gucci',
    name: 'Gucci (Kering Luxury)',
    logoEmoji: '👜',
    country: 'Italy (Florence)',
    founded: '1921',
    pronunciation: 'GOO-chee',
    famousFor: 'High-end Italian leather craftsmanship, iconic Double-G monogram canvas, horsebit loafers, and bold maximalist runway fashion.',
    priceTier: '$$$$',
    tomboyStreetwearVibe: 'Ultra-luxury heritage statement pieces paired with casual oversized denim or sneakers.',
    keyProducts: ['GG Marmont Leather Bag', 'Princetown Horsebit Loafers', 'Double G Buckle Belt', 'Oversized Monogram Cardigan']
  },
  {
    id: 'prada',
    name: 'Prada',
    ...
    country: 'Italy (Milan)',
    founded: '1913',
    pronunciation: 'PRAH-dah',
    famousFor: 'Pioneering luxury Re-Nylon backpacks, brushed leather monolith combat boots, and understated intellectual minimalism.',
    priceTier: '$$$$',
    tomboyStreetwearVibe: 'Industrial-chic luxury, chunky lug-sole boots, and sleek black nylon streetwear.',
    keyProducts: ['Monolith Lug-Sole Combat Boots', 'Re-Nylon Shoulder Bag', 'Brushed Leather Loafers', 'Triangle Logo Puffer']
  },
  {
    id: 'lululemon',
    ...
    founded: '1998',
    pronunciation: 'LOO-loo-leh-muhn',
    famousFor: 'Buttery-soft Align Nulu fabric leggings, Everywhere Belt Bags, and premium technical athleisure.',
    priceTier: '$$$',
    tomboyStreetwearVibe: 'Clean, effortless sporty athleisure worn from gym workouts to weekend cafe coffee runs.',
    keyProducts: ['Align High-Rise Pants (25")', 'Everywhere Belt Bag (1L)', 'Scuba Oversized Half-Zip Hoodie', 'Define Jacket']
  },
  {
    id: 'carhartt_wip',
    name: 'Carhartt WIP (Work In Progress)',
    logoEmoji: '🔨',
    country: 'United States & Europe',
    founded: '1889 (WIP in 1994)',
    pronunciation: 'KAHR-hahrt W-I-P',
    famousFor: 'Heavyweight duck canvas chore jackets, double-knee carpenter work pants, and rugged urban streetwear.',
    priceTier: '$$$',
    tomboyStreetwearVibe: 'The #1 gold standard for durable, utilitarian skater & tomboy workwear fashion.',
    keyProducts: ['Detroit Jacket', 'Double Knee Pants', 'Acrylic Watch Beanie', 'Pocket T-Shirt']
  },
  {
    id: 'supreme',
    ...
    founded: '1994',
    pronunciation: 'soo-PREEM',
    famousFor: 'Iconic red box-logo (Bogo) hoodies, skate culture heritage, and hyper-exclusive weekly Thursday drop collabs.',
    priceTier: '$$$$',
    tomboyStreetwearVibe: 'Underground downtown Manhattan skate culture with bold graphic tees and hype collector grails.',
    keyProducts: ['Box Logo (Bogo) Hooded Sweatshirt', 'Camp Cap Hat', 'Hanes White Tagless Tees (3-Pack)', 'Skate Decks']
  },
  {
    id: 'stussy',
    name: 'Stüssy',
    ...
    famousFor: 'Shawn Stussy handwritten graffiti signature, 8-ball graphic knits, and surf-skate streetwear history.',
    priceTier: '$$$',
    tomboyStreetwearVibe: 'Relaxed West Coast surf-and-skate vibe with cozy mohair cardigans and relaxed beach pants.',
    keyProducts: ['8-Ball Mohair Knit Sweater', 'Basic Stüssy Logo Tee', 'Brushed Beach Pants', 'Stock Low Pro Cap']
  },
  {
    id: 'levis',
