...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navItems: { id: ModuleCategory; label: string; icon: React.ReactNode; badge?: string }[] = [
    ...
    { id: 'fashion', label: 'Fashion & Shopping', icon: <ShoppingBag className="w-4 h-4" />, badge: 'NEW' },
    { id: 'formslab', label: 'Forms & Papers Lab', icon: <BookOpen className="w-4 h-4" />, badge: 'PRACTICE' },
    { id: 'dining', label: 'Dining & Dining Out', icon: <Utensils className="w-4 h-4" /> },
    { id: 'hotel', label: 'Hotels & Lodging', icon: <Hotel className="w-4 h-4" /> },
